...
const venues = [
  { name: 'Jaeger',             address: 'Grensen 9, 0159 Oslo',                  email: 'info@jaegeroslo.no' },
  { name: 'Blå',                address: 'Brenneriveien 9C, 0182 Oslo',            email: 'post@blaaoslo.no' },
  { name: 'Himkok',             address: 'Storgata 27, 0184 Oslo',                 email: 'post@himkok.no' },
  { name: 'Dattera til Hagen',  address: 'Grønland 10, 0188 Oslo',                 email: 'kontakt@dattera.no' },
  { name: 'Kulturhuset',        address: 'Youngs gate 6, 0181 Oslo',               email: 'post@kulturhusetioslo.no' },
  { name: 'Nedre Løkka',        address: 'Thorvald Meyers gate 89, 0550 Oslo',     email: 'post@nedrelokka.com' },
  { name: 'Internasjonalen',    address: 'Youngstorget 2, 0181 Oslo',              email: 'post@internasjonalen.no' },
  { name: 'Scotsman',           address: 'Karl Johans gate 17, 0159 Oslo',         email: 'oslo@scotsman.no' },
  { name: 'Rockefeller',        address: 'Torggata 16, 0183 Oslo',                 email: 'post@rockefeller.no' },
  { name: 'The Thief Bar',      address: 'Landgangen 1, 0252 Oslo',                email: 'bar@thethief.com' },
];
...
(async () => {
  ...
  console.log('Oppretter Oslo-venues...\n');
  ...
  console.log('\nFerdig! Bytt til Oslo i appen og refresh Chrome.');
})();
